  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="mt-2 flex items-center gap-3">
          <span className={`text-[10px] font-mono px-2 py-0.5 rounded uppercase ${
            isVerified ? 'text-silver-200 bg-navy-50' : 'text-white/40 bg-white/[0.03]'
          }`}>
      ...
      {seriesSchedules.length > 1 && (
        <div className="flex gap-2 bg-navy-900/60 p-2 rounded-lg border border-white/[0.06] overflow-x-auto">
